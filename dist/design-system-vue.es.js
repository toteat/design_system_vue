(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode('.tot-ds-root{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility;& *{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0;&:before,&:after{box-sizing:border-box;margin:0;padding:0}}:is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}:is(img,picture){max-width:100%;display:block}:is(input,button,textarea,select){font:inherit}:is(ul,ol){list-style:none}& a:not([class]){text-decoration-skip-ink:auto}& button{background:none;border:none;padding:0;cursor:pointer}& fieldset{border:none;padding:0;margin:0;min-width:0}& table{border-collapse:collapse;border-spacing:0}&[data-size=tiny]{font-size:var(--text-sm)}&[data-size=small]{font-size:var(--text-sm)}&[data-size=medium]{font-size:var(--text-base)}&[data-size=large]{font-size:var(--text-lg)}&[data-size=very-large]{font-size:var(--text-xl)}&[data-size=very-very-large]{font-size:var(--text-2xl)}&[data-size=ridiculously-large]{font-size:var(--text-3xl)}}.tot-ds-root{&[data-v-6bfd7cd8]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-6bfd7cd8]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-6bfd7cd8]:before,&[data-v-6bfd7cd8]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-6bfd7cd8] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-6bfd7cd8] :is(img,picture){max-width:100%;display:block}&[data-v-6bfd7cd8] :is(input,button,textarea,select){font:inherit}&[data-v-6bfd7cd8] :is(ul,ol){list-style:none}& a[data-v-6bfd7cd8]:not([class]){text-decoration-skip-ink:auto}& button[data-v-6bfd7cd8]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-6bfd7cd8]{border:none;padding:0;margin:0;min-width:0}& table[data-v-6bfd7cd8]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-6bfd7cd8]{font-size:var(--text-sm)}&[data-size=small][data-v-6bfd7cd8]{font-size:var(--text-sm)}&[data-size=medium][data-v-6bfd7cd8]{font-size:var(--text-base)}&[data-size=large][data-v-6bfd7cd8]{font-size:var(--text-lg)}&[data-size=very-large][data-v-6bfd7cd8]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-6bfd7cd8]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-6bfd7cd8]{font-size:var(--text-3xl)}}.tot-ds-root{&.spinner[data-v-6bfd7cd8]{display:flex;align-items:center;justify-content:center;width:var(--size, 1rem);height:var(--size, 1rem);border:2px solid currentColor;border-top-color:transparent;border-radius:50%;animation:spin-6bfd7cd8 1s linear infinite}}@keyframes spin-6bfd7cd8{0%{transform:rotate(0)}to{transform:rotate(360deg)}}.tot-ds-root{&[data-v-c6027be7]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-c6027be7]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-c6027be7]:before,&[data-v-c6027be7]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-c6027be7] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-c6027be7] :is(img,picture){max-width:100%;display:block}&[data-v-c6027be7] :is(input,button,textarea,select){font:inherit}&[data-v-c6027be7] :is(ul,ol){list-style:none}& a[data-v-c6027be7]:not([class]){text-decoration-skip-ink:auto}& button[data-v-c6027be7]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-c6027be7]{border:none;padding:0;margin:0;min-width:0}& table[data-v-c6027be7]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-c6027be7]{font-size:var(--text-sm)}&[data-size=small][data-v-c6027be7]{font-size:var(--text-sm)}&[data-size=medium][data-v-c6027be7]{font-size:var(--text-base)}&[data-size=large][data-v-c6027be7]{font-size:var(--text-lg)}&[data-size=very-large][data-v-c6027be7]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-c6027be7]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-c6027be7]{font-size:var(--text-3xl)}}.tot-ds-root{&.icon[data-v-c6027be7]{width:var(--size, 1rem);height:var(--size, 1rem);display:inline-block}}.tot-ds-root{&[data-v-9e2b53e3]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-9e2b53e3]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-9e2b53e3]:before,&[data-v-9e2b53e3]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-9e2b53e3] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-9e2b53e3] :is(img,picture){max-width:100%;display:block}&[data-v-9e2b53e3] :is(input,button,textarea,select){font:inherit}&[data-v-9e2b53e3] :is(ul,ol){list-style:none}& a[data-v-9e2b53e3]:not([class]){text-decoration-skip-ink:auto}& button[data-v-9e2b53e3]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-9e2b53e3]{border:none;padding:0;margin:0;min-width:0}& table[data-v-9e2b53e3]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-9e2b53e3]{font-size:var(--text-sm)}&[data-size=small][data-v-9e2b53e3]{font-size:var(--text-sm)}&[data-size=medium][data-v-9e2b53e3]{font-size:var(--text-base)}&[data-size=large][data-v-9e2b53e3]{font-size:var(--text-lg)}&[data-size=very-large][data-v-9e2b53e3]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-9e2b53e3]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-9e2b53e3]{font-size:var(--text-3xl)}}.tot-ds-root{&.btn{&[data-v-9e2b53e3]{display:flex;line-height:1;border:1.5px solid transparent;background-color:transparent;align-items:center;justify-content:center;gap:.5rem;border-radius:9999px;font-weight:600;transition:border-color .25s ease-in-out,background-color .25s ease-in-out,opacity .25s ease-in-out,color .25s ease-in-out;cursor:pointer;-webkit-tap-highlight-color:transparent;touch-action:manipulation;user-select:none}& span[data-v-9e2b53e3]{white-space:nowrap}&:not(:disabled){&.selected[data-v-9e2b53e3],&[data-v-9e2b53e3]:active{border-color:#ffffff80}}&.btn-full[data-v-9e2b53e3]{width:100%}&.btn-icon-only{&[data-v-9e2b53e3]{padding:0;aspect-ratio:1 / 1;border-radius:50%}&.btn-size-tiny[data-v-9e2b53e3]{width:2rem;height:2rem;min-width:2rem;min-height:2rem}&.btn-size-small[data-v-9e2b53e3]{width:2.75rem;height:2.75rem;min-width:2.75rem;min-height:2.75rem}&.btn-size-medium[data-v-9e2b53e3]{width:3.75rem;height:3.75rem;min-width:3.75rem;min-height:3.75rem}&.btn-size-large[data-v-9e2b53e3]{width:5rem;height:5rem;min-width:5rem;min-height:5rem}}&.btn-size-tiny[data-v-9e2b53e3]{font-size:var(--text-xs);line-height:var(--text-xs--line-height);min-width:4rem;min-height:2rem;padding-left:.75rem;padding-right:.75rem}&.btn-size-small[data-v-9e2b53e3]{font-size:var(--text-xs);line-height:var(--text-xs--line-height);min-width:4rem;min-height:2.75rem;padding-left:.75rem;padding-right:.75rem}&.btn-size-medium[data-v-9e2b53e3]{font-size:var(--text-base);line-height:var(--text-base--line-height);min-width:4.75rem;min-height:3.75rem;padding-left:1rem;padding-right:1rem}&.btn-size-large[data-v-9e2b53e3]{font-size:var(--text-2xl);line-height:var(--text-2xl--line-height);min-width:5.75rem;min-height:5rem;padding-left:1.25rem;padding-right:1.25rem}&[data-v-9e2b53e3]:hover:not(:disabled),&.btn-loading[data-v-9e2b53e3]{opacity:.3}&.btn-primary[data-v-9e2b53e3]{background-color:var(--color-primary);color:var(--color-neutral)}&.btn-secondary[data-v-9e2b53e3]{background-color:var(--color-secondary);color:var(--color-neutral)}&.btn-outline{&[data-v-9e2b53e3]{border-color:var(--color-secondary);color:var(--color-secondary)}&:not(:disabled){&.selected[data-v-9e2b53e3],&[data-v-9e2b53e3]:hover{border-color:var(--color-primary)}&.selected[data-v-9e2b53e3]{border-color:var(--color-primary);color:var(--color-primary)}&:active{&[data-v-9e2b53e3]{border-color:var(--color-primary-light);color:var(--color-primary-light)}svg[data-v-9e2b53e3]{fill:var(--color-primary-light)}}}}&.btn-text[data-v-9e2b53e3]{color:var(--color-secondary);border-width:0;border-style:solid;border-color:currentColor}&.btn-neutral-dark[data-v-9e2b53e3]{background-color:var(--color-neutral-500);color:var(--color-neutral)}&[data-v-9e2b53e3]:disabled{cursor:not-allowed;filter:grayscale(1) opacity(.25)}svg[data-v-9e2b53e3]{flex-shrink:0;transition-property:fill;transition-duration:.25s;transition-timing-function:ease-in-out}}}.tot-ds-root{&[data-v-9bda909b]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-9bda909b]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-9bda909b]:before,&[data-v-9bda909b]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-9bda909b] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-9bda909b] :is(img,picture){max-width:100%;display:block}&[data-v-9bda909b] :is(input,button,textarea,select){font:inherit}&[data-v-9bda909b] :is(ul,ol){list-style:none}& a[data-v-9bda909b]:not([class]){text-decoration-skip-ink:auto}& button[data-v-9bda909b]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-9bda909b]{border:none;padding:0;margin:0;min-width:0}& table[data-v-9bda909b]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-9bda909b]{font-size:var(--text-sm)}&[data-size=small][data-v-9bda909b]{font-size:var(--text-sm)}&[data-size=medium][data-v-9bda909b]{font-size:var(--text-base)}&[data-size=large][data-v-9bda909b]{font-size:var(--text-lg)}&[data-size=very-large][data-v-9bda909b]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-9bda909b]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-9bda909b]{font-size:var(--text-3xl)}}.tot-ds-root{&.skeleton-preload[data-v-9bda909b]{width:var(--skeleton-width);height:var(--skeleton-height);background:linear-gradient(90deg,var(--color-neutral-200) 0%,var(--color-neutral-100) 50%,var(--color-neutral-200) 100%);background-size:200% 100%;background-color:var(--color-primary-light);animation:shimmer-9bda909b 1.5s infinite;opacity:1;visibility:visible;border-radius:var(--skeleton-border-radius)}}@keyframes shimmer-9bda909b{0%{background-position:200% 0}to{background-position:-200% 0}}.tot-ds-root{&[data-v-8a5e33c8]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-8a5e33c8]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-8a5e33c8]:before,&[data-v-8a5e33c8]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-8a5e33c8] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-8a5e33c8] :is(img,picture){max-width:100%;display:block}&[data-v-8a5e33c8] :is(input,button,textarea,select){font:inherit}&[data-v-8a5e33c8] :is(ul,ol){list-style:none}& a[data-v-8a5e33c8]:not([class]){text-decoration-skip-ink:auto}& button[data-v-8a5e33c8]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-8a5e33c8]{border:none;padding:0;margin:0;min-width:0}& table[data-v-8a5e33c8]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-8a5e33c8]{font-size:var(--text-sm)}&[data-size=small][data-v-8a5e33c8]{font-size:var(--text-sm)}&[data-size=medium][data-v-8a5e33c8]{font-size:var(--text-base)}&[data-size=large][data-v-8a5e33c8]{font-size:var(--text-lg)}&[data-size=very-large][data-v-8a5e33c8]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-8a5e33c8]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-8a5e33c8]{font-size:var(--text-3xl)}}.tot-ds-root{&.image-preview[data-v-8a5e33c8]{position:relative;display:flex;align-items:center;justify-content:center;background-color:var(--color-neutral-100);border-radius:var(--border-radius);overflow:hidden}}.tot-ds-root img[data-v-8a5e33c8]{object-fit:cover}.tot-ds-root .image-preview__loading[data-v-8a5e33c8]{width:100%;height:100%}.tot-ds-root .image-preview__error{&[data-v-8a5e33c8]{width:100%;height:100%;display:flex;align-items:center;justify-content:center;background-color:var(--color-neutral-100);color:var(--color-red)}>.tot-ds-root.icon[data-v-8a5e33c8]{width:60%;height:60%}}.tot-ds-root .visually-hidden[data-v-8a5e33c8]{opacity:0;position:absolute;pointer-events:none}.tot-ds-root{&[data-v-67caf3da]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-67caf3da]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-67caf3da]:before,&[data-v-67caf3da]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-67caf3da] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-67caf3da] :is(img,picture){max-width:100%;display:block}&[data-v-67caf3da] :is(input,button,textarea,select){font:inherit}&[data-v-67caf3da] :is(ul,ol){list-style:none}& a[data-v-67caf3da]:not([class]){text-decoration-skip-ink:auto}& button[data-v-67caf3da]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-67caf3da]{border:none;padding:0;margin:0;min-width:0}& table[data-v-67caf3da]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-67caf3da]{font-size:var(--text-sm)}&[data-size=small][data-v-67caf3da]{font-size:var(--text-sm)}&[data-size=medium][data-v-67caf3da]{font-size:var(--text-base)}&[data-size=large][data-v-67caf3da]{font-size:var(--text-lg)}&[data-size=very-large][data-v-67caf3da]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-67caf3da]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-67caf3da]{font-size:var(--text-3xl)}}.tot-ds-root{&.drop-zone-container{&[data-v-67caf3da]{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2rem;width:100%}.image-preview-grid{&[data-v-67caf3da]{display:grid;grid-template-columns:repeat(auto-fill,minmax(70px,1fr));grid-auto-rows:auto;grid-gap:1.5rem;width:100%;justify-items:center}button{&[data-v-67caf3da]{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.5rem;padding:.125rem .125rem .5rem;border-radius:.5rem;transition-property:fill,transform,background-color,padding;transition-duration:.2s;transition-timing-function:ease-in-out;background-color:transparent}svg[data-v-67caf3da]{transition-property:fill,transform,color;transition-duration:.2s;transition-timing-function:ease-in-out}&:hover{&[data-v-67caf3da]{background-color:var(--color-gray-100);transform:scale(1.25)}svg[data-v-67caf3da]{fill:var(--color-primary)}}}}.drop-zone{&[data-v-67caf3da]{border:.125rem dashed var(--color-neutral-300, #ccc);border-radius:.5rem;padding:2rem;text-align:center;cursor:pointer;transition:border-color .2s,background .2s,opacity .2s;background:var(--color-neutral-100, #fafafa);outline:none;width:100%;position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0}&[data-v-67caf3da]:hover{opacity:.5}.tot-ds-root.btn[data-v-67caf3da]:hover:not(:disabled){opacity:1}}.drop-zone__file-list[data-v-67caf3da]{display:flex;flex-flow:row wrap;gap:.5rem}.drop-zone--dragging[data-v-67caf3da]{border-color:var(--color-primary-500, #007bff);background:var(--color-primary-50, #e6f0ff)}.drop-zone--processing[data-v-67caf3da]{opacity:.6;cursor:wait}.drop-zone__input[data-v-67caf3da]{display:none}.drop-zone__browse[data-v-67caf3da]{color:var(--color-primary-500, #007bff);text-decoration:underline;cursor:pointer}}}.tot-ds-root{&[data-v-6fb9b7ec]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-6fb9b7ec]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-6fb9b7ec]:before,&[data-v-6fb9b7ec]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-6fb9b7ec] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-6fb9b7ec] :is(img,picture){max-width:100%;display:block}&[data-v-6fb9b7ec] :is(input,button,textarea,select){font:inherit}&[data-v-6fb9b7ec] :is(ul,ol){list-style:none}& a[data-v-6fb9b7ec]:not([class]){text-decoration-skip-ink:auto}& button[data-v-6fb9b7ec]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-6fb9b7ec]{border:none;padding:0;margin:0;min-width:0}& table[data-v-6fb9b7ec]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-6fb9b7ec]{font-size:var(--text-sm)}&[data-size=small][data-v-6fb9b7ec]{font-size:var(--text-sm)}&[data-size=medium][data-v-6fb9b7ec]{font-size:var(--text-base)}&[data-size=large][data-v-6fb9b7ec]{font-size:var(--text-lg)}&[data-size=very-large][data-v-6fb9b7ec]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-6fb9b7ec]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-6fb9b7ec]{font-size:var(--text-3xl)}}.tot-ds-root{&.checkbox{&[data-v-6fb9b7ec]{display:inline-flex;align-items:center;gap:.5rem;cursor:pointer;user-select:none;position:relative;font-family:inherit}.checkbox__native[data-v-6fb9b7ec]{position:absolute;opacity:0;width:0;height:0;pointer-events:none}.checkbox__visual[data-v-6fb9b7ec]{display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;transition:opacity .2s ease-in-out}.checkbox__label[data-v-6fb9b7ec]{flex:1}&[data-checkbox-position=left]{.checkbox__visual[data-v-6fb9b7ec]{order:1}.checkbox__label[data-v-6fb9b7ec]{order:2}}&[data-checkbox-position=right]{.checkbox__visual[data-v-6fb9b7ec]{order:2}.checkbox__label[data-v-6fb9b7ec]{order:1}}&[data-full-width=true][data-v-6fb9b7ec]{display:flex;width:100%}.checkbox__native:focus+.checkbox__visual[data-v-6fb9b7ec]{outline:none;opacity:.8}&:hover:not(.checkbox-disabled) .checkbox__visual[data-v-6fb9b7ec]{opacity:.8}&.checkbox-disabled{&[data-v-6fb9b7ec]{cursor:not-allowed}.checkbox__visual[data-v-6fb9b7ec]{opacity:.5}}&:not(.checkbox-disabled):active .checkbox__visual[data-v-6fb9b7ec]{opacity:.6}}}.tot-ds-root{&[data-v-eb81e19d]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-eb81e19d]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-eb81e19d]:before,&[data-v-eb81e19d]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-eb81e19d] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-eb81e19d] :is(img,picture){max-width:100%;display:block}&[data-v-eb81e19d] :is(input,button,textarea,select){font:inherit}&[data-v-eb81e19d] :is(ul,ol){list-style:none}& a[data-v-eb81e19d]:not([class]){text-decoration-skip-ink:auto}& button[data-v-eb81e19d]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-eb81e19d]{border:none;padding:0;margin:0;min-width:0}& table[data-v-eb81e19d]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-eb81e19d]{font-size:var(--text-sm)}&[data-size=small][data-v-eb81e19d]{font-size:var(--text-sm)}&[data-size=medium][data-v-eb81e19d]{font-size:var(--text-base)}&[data-size=large][data-v-eb81e19d]{font-size:var(--text-lg)}&[data-size=very-large][data-v-eb81e19d]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-eb81e19d]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-eb81e19d]{font-size:var(--text-3xl)}}.tot-ds-root{&.tooltip-wrapper[data-v-eb81e19d]{position:relative;display:inline-block}.tooltip-trigger[data-v-eb81e19d]{display:inline-block}.tooltip-content{&[data-v-eb81e19d]{position:absolute;z-index:9999;pointer-events:none}&[data-position=top][data-v-eb81e19d]{bottom:calc(100% + 5px);left:50%;transform:translate(-50%);animation:tooltip-slide-in-top-eb81e19d .3s cubic-bezier(.175,.885,.32,1.1)}&[data-position=bottom][data-v-eb81e19d]{top:calc(100% + 5px);left:50%;transform:translate(-50%);animation:tooltip-slide-in-bottom-eb81e19d .3s cubic-bezier(.175,.885,.32,1.1)}&[data-position=left][data-v-eb81e19d]{right:calc(100% + 5px);top:50%;transform:translateY(-50%);animation:tooltip-slide-in-left-eb81e19d .3s cubic-bezier(.175,.885,.32,1.1)}&[data-position=right][data-v-eb81e19d]{left:calc(100% + 5px);top:50%;transform:translateY(-50%);animation:tooltip-slide-in-right-eb81e19d .3s cubic-bezier(.175,.885,.32,1.1)}}.tooltip-box{&[data-v-eb81e19d]{position:relative;display:inline-flex;background:var(--color-neutral-500);border-radius:.5rem;padding:.5rem;min-height:2rem;box-shadow:0 2px 8px #00000026}&[data-v-eb81e19d]:before{content:"";position:absolute;width:0;height:0;border-style:solid}}.tooltip-content[data-position=top] .tooltip-box[data-v-eb81e19d]:before{bottom:-7px;left:50%;transform:translate(-50%);border-width:7px 7px 0 7px;border-color:var(--color-neutral-500) transparent transparent transparent}.tooltip-content[data-position=bottom] .tooltip-box[data-v-eb81e19d]:before{top:-7px;left:50%;transform:translate(-50%);border-width:0 7px 7px 7px;border-color:transparent transparent var(--color-neutral-500) transparent}.tooltip-content[data-position=left] .tooltip-box[data-v-eb81e19d]:before{right:-7px;top:50%;transform:translateY(-50%);border-width:7px 0 7px 7px;border-color:transparent transparent transparent var(--color-neutral-500)}.tooltip-content[data-position=right] .tooltip-box[data-v-eb81e19d]:before{left:-7px;top:50%;transform:translateY(-50%);border-width:7px 7px 7px 0;border-color:transparent var(--color-neutral-500) transparent transparent}.tooltip-text[data-v-eb81e19d]{color:var(--color-white);font-size:var(--text-sm);line-height:var(--text-sm--line-height);text-align:center;overflow-wrap:break-word;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:3;line-clamp:3;width:max-content;max-width:16rem;overflow:hidden;text-overflow:ellipsis}}@keyframes tooltip-slide-in-top-eb81e19d{0%{opacity:0;transform:translate(-50%) translateY(8px)}to{opacity:1;transform:translate(-50%) translateY(0)}}@keyframes tooltip-slide-in-bottom-eb81e19d{0%{opacity:0;transform:translate(-50%) translateY(-8px)}to{opacity:1;transform:translate(-50%) translateY(0)}}@keyframes tooltip-slide-in-left-eb81e19d{0%{opacity:0;transform:translateY(-50%) translate(8px)}to{opacity:1;transform:translateY(-50%) translate(0)}}@keyframes tooltip-slide-in-right-eb81e19d{0%{opacity:0;transform:translateY(-50%) translate(-8px)}to{opacity:1;transform:translateY(-50%) translate(0)}}.tot-ds-root{&[data-v-3c536d4f]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-3c536d4f]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-3c536d4f]:before,&[data-v-3c536d4f]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-3c536d4f] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-3c536d4f] :is(img,picture){max-width:100%;display:block}&[data-v-3c536d4f] :is(input,button,textarea,select){font:inherit}&[data-v-3c536d4f] :is(ul,ol){list-style:none}& a[data-v-3c536d4f]:not([class]){text-decoration-skip-ink:auto}& button[data-v-3c536d4f]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-3c536d4f]{border:none;padding:0;margin:0;min-width:0}& table[data-v-3c536d4f]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-3c536d4f]{font-size:var(--text-sm)}&[data-size=small][data-v-3c536d4f]{font-size:var(--text-sm)}&[data-size=medium][data-v-3c536d4f]{font-size:var(--text-base)}&[data-size=large][data-v-3c536d4f]{font-size:var(--text-lg)}&[data-size=very-large][data-v-3c536d4f]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-3c536d4f]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-3c536d4f]{font-size:var(--text-3xl)}}.tot-ds-root{&.multiselect[data-v-3c536d4f]{position:relative;width:100%;font-family:inherit}.multiselect__selected-wrapper[data-v-3c536d4f]{border:1px solid var(--color-neutral-300);border-radius:.5rem;padding:.5rem 3rem .5rem .5rem;margin-top:.5rem;position:relative}&.multiselect-open .multiselect__selected-wrapper[data-v-3c536d4f],&.multiselect-dropdown-animating .multiselect__selected-wrapper[data-v-3c536d4f]{position:absolute;z-index:1;top:3rem;left:0;right:0;margin-top:0}.multiselect__selected-tags[data-v-3c536d4f]{display:flex;flex-wrap:wrap;gap:.375rem;align-items:center;justify-content:flex-start}.multiselect__tag[data-v-3c536d4f]{flex-shrink:0}.multiselect__clear-all[data-v-3c536d4f]{position:absolute;bottom:.5rem;right:.5rem}.multiselect__trigger{&[data-v-3c536d4f]{display:flex;align-items:center;justify-content:space-between;gap:.5rem;background-color:var(--color-neutral);border:1.5px solid var(--color-neutral-300);border-radius:.5rem;cursor:pointer;transition:all .2s ease-in-out;min-height:3rem;padding:0 0 0 .75rem}&[data-v-3c536d4f]:hover:not(.multiselect-disabled &){border-color:var(--color-neutral-400)}&[data-v-3c536d4f]:focus{outline:none;border-color:var(--color-primary);box-shadow:0 0 0 3px #007bff1a}}.multiselect__trigger-text[data-v-3c536d4f]{flex:1;color:var(--color-neutral-400)}&.multiselect-open .multiselect__trigger[data-v-3c536d4f]{border-color:var(--color-black)}&.multiselect-disabled .multiselect__trigger[data-v-3c536d4f]{cursor:not-allowed;opacity:.5;background-color:var(--color-neutral-100)}.multiselect__input-wrapper{&[data-v-3c536d4f]{display:flex;align-items:center;justify-content:space-between;background-color:var(--color-neutral);border:1.5px solid var(--color-neutral-300);border-radius:.5rem;transition:all .2s ease-in-out;min-height:3rem;position:relative}&[data-v-3c536d4f]:hover:not(.multiselect-disabled &){border-color:var(--color-neutral-400)}&[data-v-3c536d4f]:focus-within{border-color:var(--color-primary);box-shadow:0 0 0 3px #007bff1a}}&.multiselect-open .multiselect__input-wrapper[data-v-3c536d4f]{border-color:var(--color-primary)}&.multiselect-disabled .multiselect__input-wrapper[data-v-3c536d4f]{cursor:not-allowed;opacity:.5;background-color:var(--color-neutral-100)}&.multiselect-size-tiny{.multiselect__trigger[data-v-3c536d4f],.multiselect__input-wrapper[data-v-3c536d4f]{min-height:2rem;font-size:var(--text-xs)}.multiselect__search-input[data-v-3c536d4f]{padding:.25rem 0 .25rem .5rem}.multiselect__actions[data-v-3c536d4f]{padding:.25rem .5rem}}&.multiselect-size-small{.multiselect__trigger[data-v-3c536d4f],.multiselect__input-wrapper[data-v-3c536d4f]{min-height:2.5rem;font-size:var(--text-sm)}.multiselect__search-input[data-v-3c536d4f]{padding:.375rem 0 .375rem .625rem}.multiselect__actions[data-v-3c536d4f]{padding:.375rem .625rem .375rem .5rem}}&.multiselect-size-medium{.multiselect__trigger[data-v-3c536d4f],.multiselect__input-wrapper[data-v-3c536d4f]{min-height:3rem;font-size:var(--text-base)}.multiselect__search-input[data-v-3c536d4f]{padding:.5rem 0 .5rem .75rem}.multiselect__actions[data-v-3c536d4f]{padding:.5rem .75rem .5rem .5rem}}&.multiselect-size-large{.multiselect__trigger[data-v-3c536d4f],.multiselect__input-wrapper[data-v-3c536d4f]{min-height:3.75rem;font-size:var(--text-lg)}.multiselect__search-input[data-v-3c536d4f]{padding:.75rem 0 .75rem 1rem}.multiselect__actions[data-v-3c536d4f]{padding:.75rem 1rem .75rem .5rem}}.multiselect__search-input{&[data-v-3c536d4f]{flex:1;border:none;outline:none;font-size:inherit;background:transparent;font-family:inherit;color:var(--color-neutral-900)}&[data-v-3c536d4f]::placeholder{color:var(--color-neutral-400)}&[data-v-3c536d4f]:disabled{cursor:not-allowed}}.multiselect__clear{&[data-v-3c536d4f]{display:inline-flex;align-items:center;background:none;border:none;cursor:pointer;padding:.25rem;transition:opacity .2s}&[data-v-3c536d4f]:hover{opacity:.7}}.multiselect__actions{&[data-v-3c536d4f]{display:flex;align-items:center;align-self:stretch;flex-shrink:0;border-left:1px solid var(--color-neutral-300);min-width:44px;justify-content:center;cursor:pointer;transition:opacity .2s ease-in-out}&[data-v-3c536d4f]:hover{opacity:.7}}.multiselect__arrow[data-v-3c536d4f]{flex-shrink:0;transition:transform .2s ease-out}&.multiselect-open .multiselect__arrow[data-v-3c536d4f]{transform:rotate(180deg)}.multiselect__dropdown[data-v-3c536d4f]{position:relative;z-index:2;background-color:var(--color-neutral);border:1.5px solid var(--color-neutral-300);border-radius:.5rem;box-shadow:0 4px 6px -1px #0000001a,0 2px 4px -1px #0000000f;max-height:300px;overflow:hidden;display:flex;flex-direction:column;margin-top:.25rem}.multiselect__limit-info{&[data-v-3c536d4f]{padding:.5rem .75rem;font-size:var(--text-sm);color:var(--color-neutral-400);background-color:var(--color-neutral-100);border-bottom:1px solid var(--color-neutral-200);text-align:center;transition:background-color .3s ease-in-out,color .3s ease-in-out}&.multiselect__limit-info--max[data-v-3c536d4f]{color:var(--color-white);background-color:var(--color-black);border-bottom-color:var(--color-black);font-weight:700;animation:limitPulse-3c536d4f 1.5s ease-in-out infinite}}@keyframes limitPulse-3c536d4f{0%,to{opacity:1}50%{opacity:.7}}.multiselect__options[data-v-3c536d4f]{list-style:none;margin:0;padding:.25rem 0;overflow-y:auto;max-height:240px}.multiselect__option{&[data-v-3c536d4f]{display:block;padding:0}&.multiselect__option-disabled[data-v-3c536d4f]{opacity:.5}}.multiselect__checkbox{&[data-v-3c536d4f]{width:100%;padding:.625rem .75rem;border-radius:0;transition:background-color .15s ease-in-out;font-size:var(--text-sm);gap:.5rem}&[data-v-3c536d4f]:hover:not(:disabled){background-color:var(--color-tertiary-light)}.multiselect__option-selected &[data-v-3c536d4f]{background-color:#007bff0d}&[data-v-3c536d4f]:disabled{cursor:not-allowed}}.multiselect__no-options[data-v-3c536d4f]{padding:1rem .75rem;text-align:center;color:var(--color-neutral-400);font-size:.875rem}.multiselect-dropdown-enter-active[data-v-3c536d4f],.multiselect-dropdown-leave-active[data-v-3c536d4f]{transition:all .2s ease-in-out;transform-origin:top}.multiselect-dropdown-enter-from[data-v-3c536d4f],.multiselect-dropdown-leave-to[data-v-3c536d4f]{opacity:0;transform:scaleY(.95) translateY(-.5rem)}.multiselect-dropdown-enter-to[data-v-3c536d4f],.multiselect-dropdown-leave-from[data-v-3c536d4f]{opacity:1;transform:scaleY(1) translateY(0)}}.tot-ds-root{&[data-v-2456a115]{--color-primary: #ff4235;--color-primary-light: #ffa099;--color-secondary: #1b1b1b;--color-secondary-light: #b3b3b3;--color-tertiary: #e6d9ca;--color-tertiary-light: #f7f3ee;--color-white: #ffffff;--color-black: #000000;--color-neutral: #ffffff;--color-neutral-100: #f2f2f2;--color-neutral-200: #dddddd;--color-neutral-300: #cfcfcf;--color-neutral-400: #a1a1a1;--color-neutral-500: #464646;--color-gray-100: #f2f2f2;--color-gray-200: #dddddd;--color-gray-300: #cfcfcf;--color-gray-400: #a1a1a1;--color-gray-500: #464646;--color-blue: #275ffd;--color-blue-light: #cef3f7;--color-green: #46d281;--color-green-light: #cdf3db;--color-yellow: #fbcc29;--color-yellow-light: #ffecce;--color-red: #e12845;--color-red-light: #fbd7dd;--blue-text: #123599;--green-text: #2c7f4f;--yellow-text: #b29017;--red-text: #6b0414;--text-xs: 12px;--text-sm: 14px;--text-base: 16px;--text-lg: 20px;--text-xl: 24px;--text-2xl: 32px;--text-3xl: 40px;--text-4xl: 48px;--text-5xl: 56px;--text-6xl: 64px;--text-xs--line-height: 16px;--text-sm--line-height: 20px;--text-base--line-height: 24px;--text-lg--line-height: 28px;--text-xl--line-height: 32px;--text-2xl--line-height: 40px;--text-3xl--line-height: 48px;--text-4xl--line-height: 56px;--text-5xl--line-height: 64px;--text-6xl--line-height: 72px;font-family:Manrope,Helvetica,Arial,sans-serif;line-height:1.5;font-weight:400;color:#000;font-synthesis:none;text-rendering:optimizeLegibility}& *{&[data-v-2456a115]{font-family:Manrope,Helvetica,Arial,sans-serif;box-sizing:border-box;margin:0;padding:0}&[data-v-2456a115]:before,&[data-v-2456a115]:after{box-sizing:border-box;margin:0;padding:0}}&[data-v-2456a115] :is(h1,h2,h3,h4,p,figure,blockquote,dl,dd){margin:0}&[data-v-2456a115] :is(img,picture){max-width:100%;display:block}&[data-v-2456a115] :is(input,button,textarea,select){font:inherit}&[data-v-2456a115] :is(ul,ol){list-style:none}& a[data-v-2456a115]:not([class]){text-decoration-skip-ink:auto}& button[data-v-2456a115]{background:none;border:none;padding:0;cursor:pointer}& fieldset[data-v-2456a115]{border:none;padding:0;margin:0;min-width:0}& table[data-v-2456a115]{border-collapse:collapse;border-spacing:0}&[data-size=tiny][data-v-2456a115]{font-size:var(--text-sm)}&[data-size=small][data-v-2456a115]{font-size:var(--text-sm)}&[data-size=medium][data-v-2456a115]{font-size:var(--text-base)}&[data-size=large][data-v-2456a115]{font-size:var(--text-lg)}&[data-size=very-large][data-v-2456a115]{font-size:var(--text-xl)}&[data-size=very-very-large][data-v-2456a115]{font-size:var(--text-2xl)}&[data-size=ridiculously-large][data-v-2456a115]{font-size:var(--text-3xl)}}.tot-ds-root{&.logo-toteat{&[data-v-2456a115]{display:inline-flex;align-items:center;justify-content:center;margin:0;padding:0}[data-v-2456a115] svg{display:block;margin:0;padding:0;transition:opacity .2s ease-in-out;&:hover{opacity:.9}}}&[data-mode=icon]{[data-v-2456a115] svg{max-width:100px;max-height:100px}}&[data-mode=complete]{[data-v-2456a115] svg{max-width:400px;max-height:100px}}}')),document.head.appendChild(e)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
import { defineComponent as b, createElementBlock as _, openBlock as h, normalizeStyle as K, computed as I, normalizeClass as B, createBlock as H, createCommentVNode as O, toDisplayString as U, getCurrentScope as C0, onScopeDispose as N0, ref as M, shallowRef as X, watch as F, onMounted as l0, onUnmounted as c0, createElementVNode as g, Fragment as W, renderList as G, withModifiers as Y, createVNode as k, getCurrentInstance as E0, renderSlot as o0, nextTick as g0, onBeforeUnmount as H0, withDirectives as A0, withKeys as $, vModelText as V0, Transition as J, withCtx as x, createTextVNode as T0 } from "vue";
const w0 = /* @__PURE__ */ b({
  __name: "Spinner",
  props: {
    size: { default: 4 }
  ...
  for (const [a, n] of l)
    e[a] = n;
  return e;
}, n0 = /* @__PURE__ */ R(w0, [["__scopeId", "data-v-6bfd7cd8"]]), y0 = [
  ...
  __proto__: null,
  ICON_APPLE_FILLED: y0,
  ICON_ARROW_CIRCLE_DOWN_OUTLINE: b0,
  ICON_ARROW_CIRCLE_LEFT_OUTLINE: R0,
  ICON_ARROW_CIRCLE_RIGHT_OUTLINE: k0,
  ICON_ARROW_CIRCLE_UP_OUTLINE: U0,
  ICON_ARROW_DOWN_OUTLINE: P0,
  ICON_ARROW_LEFT_OUTLINE: D0,
  ICON_ARROW_LIST_OUTLINE: B0,
  ICON_ARROW_POINT_DOWN_FILLED: F0,
  ICON_ARROW_POINT_LEFT_FILLED: z0,
  ICON_ARROW_POINT_RIGHT_FILLED: S0,
  ICON_ARROW_POINT_UP_FILLED: $0,
  ICON_ARROW_RIGHT_OUTLINE: x0,
  ICON_ARROW_UP_OUTLINE: W0,
  ICON_BARCODE_OUTLINE: G0,
  ICON_CALENDAR_ALT_OUTLINE: Y0,
  ICON_CALENDAR_LOCKED_OUTLINE: K0,
  ICON_CALENDAR_OUTLINE: j0,
  ICON_CARROT_FILLED: X0,
  ICON_CHECKBOX_CHECKED: Q0,
  ICON_CHECKBOX_UNCHECKED: q0,
  ICON_CHECK_OUTLINE: J0,
  ICON_CHEVRON_DOWN_OUTLINE: e1,
  ICON_CHEVRON_LEFT_BICOLOR: a1,
  ICON_CHEVRON_LEFT_OUTLINE: t1,
  ICON_CHEVRON_RIGHT_BICOLOR: l1,
  ICON_CHEVRON_RIGHT_OUTLINE: c1,
  ICON_CHEVRON_UP_OUTLINE: o1,
  ICON_CHICKEN_FILLED: n1,
  ICON_CHILI_FILLED: s1,
  ICON_CLOSE_OUTLINE: i1,
  ICON_CLOUD_DOWNLOAD_OUTLINE: d1,
  ICON_CLOUD_UPLOAD_OUTLINE: r1,
  ICON_COPY_GENERIC_OUTLINE: h1,
  ICON_COPY_SQUARE_OUTLINE: v1,
  ICON_DELETE_OUTLINE: u1,
  ICON_DISCOUNT_OUTLINE: p1,
  ICON_DOCUMENT_GENERIC_OUTLINE: _1,
  ICON_DOCUMENT_HISTORY_ALT_OUTLINE: m1,
  ICON_DOCUMENT_HISTORY_OUTLINE: f1,
  ICON_DOCUMENT_LIST_OUTLINE: Z1,
  ICON_ERROR_FILLED_RED: M1,
  ICON_ERROR_OUTLINE: L1,
  ICON_EXCLAMATION_OUTLINE: I1,
  ICON_EXPAND_OUTLINE: O1,
  ICON_EXPORT_OUTLINE: C1,
  ICON_EYE_CLOSED_OUTLINE: N1,
  ICON_EYE_OPEN_FILLED: E1,
  ICON_EYE_OPEN_OUTLINE: g1,
  ICON_FACEBOOK_FILLED: H1,
  ICON_FIRE_FILLED: A1,
  ICON_FISH_FILLED: V1,
  ICON_GOOGLE_FILLED: T1,
  ICON_HASHTAG_OUTLINE: w1,
  ICON_HOME_OUTLINE: y1,
  ICON_IMPORT_OUTLINE: b1,
  ICON_INFO_FILLED_BLUE: R1,
  ICON_INFO_OUTLINE: k1,
  ICON_INSTAGRAM_FILLED: U1,
  ICON_LACTOSE_INTOLERANT_FILLED: P1,
  ICON_LAYOUT_1_OUTLINE: D1,
  ICON_LAYOUT_2_OUTLINE: B1,
  ICON_LAYOUT_3_OUTLINE: F1,
  ICON_LAYOUT_4_OUTLINE: z1,
  ICON_LAYOUT_5_OUTLINE: S1,
  ICON_LEAF_FILLED: $1,
  ICON_LINKEDIN_FILLED: x1,
  ICON_LOCATION_FILLED: W1,
  ICON_MAIL_OUTLINE: G1,
  ICON_MENU_CLOSE_OUTLINE: Y1,
  ICON_MENU_HAMBURGER_OUTLINE: K1,
  ICON_MINUS_BICOLOR_TERTIARY: j1,
  ICON_MINUS_BICOLOR_TERTIARY_LIGHT: X1,
  ICON_MINUS_FILLED: Q1,
  ICON_MONEY_BILL_OUTLINE: q1,
  ICON_MONEY_CASH_OUTLINE: J1,
  ICON_MONEY_COIN_OUTLINE: e5,
  ICON_MONEY_CREDIT_CARD_OUTLINE: a5,
  ICON_NFC_FILLED: t5,
  ICON_NFC_OUTLINE: l5,
  ICON_PENCIL: c5,
  ICON_PENCIL_OUTLINE: o5,
  ICON_PHONE_OUTLINE: n5,
  ICON_PLUS_BICOLOR_TERTIARY: s5,
  ICON_PLUS_BICOLOR_TERTIARY_LIGHT: i5,
  ICON_PLUS_FILLED: d5,
  ICON_PRINTER_OUTLINE: r5,
  ICON_PURCHASE_ORDER_BILL_OUTLINE: h5,
  ICON_PURCHASE_ORDER_LIST_OUTLINE: v5,
  ICON_PURCHASE_ORDER_TICKET_OUTLINE: u5,
  ICON_RADIO_BUTTON_CHECKED_OUTLINE: p5,
  ICON_RADIO_BUTTON_UNCHECKED_OUTLINE: _5,
  ICON_REFRESH_DOUBLE_OUTLINE: m5,
  ICON_REFRESH_SINGLE_OUTLINE: f5,
  ICON_ROCKET_OUTLINE: Z5,
  ICON_SEARCH_OUTLINE: M5,
  ICON_SHEET_BENT_OUTLINE: L5,
  ICON_SHEET_GENERIC_OUTLINE: I5,
  ICON_SHEET_LIST_OUTLINE: O5,
  ICON_SHOPPING_BAG_OUTLINE: C5,
  ICON_SHOPPING_BASKET_OUTLINE: N5,
  ICON_SHOPPING_CART_OUTLINE: E5,
  ICON_SPLIT_BILL_TICKET_1_OUTLINE: g5,
  ICON_SPLIT_BILL_TICKET_2_OUTLINE: H5,
  ICON_STAR_FILLED: A5,
  ICON_SUCCESS_FILLED_GREEN: V5,
  ICON_SUCCESS_OUTLINE: T5,
  ICON_SUGAR_FREE_FILLED: w5,
  ICON_TAG_FILLED: y5,
  ICON_TAG_OUTLINE: b5,
  ICON_TAP_CLICK_HAND_OUTLINE: R5,
  ICON_TICKETS_OUTLINE: k5,
  ICON_TICKET_OUTLINE: U5,
  ICON_TWITTER_FILLED: P5,
  ICON_USER_OUTLINE: D5,
  ICON_WARNING_FILLED_YELLOW: B5,
  ICON_WARNING_OUTLINE: F5,
  ICON_WHATSAPP_OUTLINE: z5,
  ICON_WHEAT_FILLED: S5,
  ICON_WIFI_SIGNAL_FILLED: $5,
  ICON_WIFI_SIGNAL_OUTLINE: x5
}, Symbol.toStringTag, { value: "Module" })), W5 = ["fill", "viewBox", "test-id", "innerHTML"], G5 = /* @__PURE__ */ b({
  __name: "Icon",
  props: {
  ...
  setup(t) {
    const l = t, e = I(() => {
      const n = `ICON_${l.name.replace(/-/g, "_").toUpperCase()}`;
      if (n in e0) {
        const c = e0[n];
        if (Array.isArray(c) && c.length === 2)
          return { path: c[0], viewBox: c[1] };
      }
      return console.warn(
        `[Icon.vue] Icon content not found for name: ${l.name} (resolved to key: ${n})`
      ), { path: "", viewBox: "0 0 16 16" };
    }), a = I(() => l.name.endsWith("-outline") || l.name.endsWith("-filled"));
    return (n, c) => (h(), _("svg", {
...
}), y = /* @__PURE__ */ R(G5, [["__scopeId", "data-v-c6027be7"]]), Y5 = ["variant", "aria-label", "disabled", "type", "test-id", "tabindex"], K5 = { key: 2 }, j5 = /* @__PURE__ */ b({
  __name: "Button",
  props: {
  ...
  setup(t, { emit: l }) {
    const e = t, a = l, n = {
      ...
      text: "black",
      "neutral-dark": "white"
    }, o = (i) => i ? n[i] : n.small, v = (i) => i ? c[i] : c.primary, s = I(() => [
      "tot-ds-root",
      "btn",
      `btn-${e.variant}`,
      `btn-size-${e.size}`,
    ...
    return (i, m) => (h(), _("button", {
      ...
      onClick: m[0] || (m[0] = (L) => a("click", L))
    }, [
      e.loading ? (h(), H(n0, {
        key: 0,
        size: o(e.size)
      }, null, 8, ["size"])) : O("", !0),
      !e.loading && e.iconName && e.iconPosition === "left" ? (h(), H(y, {
        key: 1,
        name: e.iconName,
        size: o(e.size),
        color: v(e.variant),
      ...
      e.text && !e.onlyIcon ? (h(), _("span", K5, U(e.text), 1)) : O("", !0),
      !e.loading && e.iconName && e.iconPosition === "right" ? (h(), H(y, {
        key: 3,
        name: e.iconName,
        size: o(e.size),
        color: v(e.variant),
...
}), z = /* @__PURE__ */ R(j5, [["__scopeId", "data-v-9e2b53e3"]]), a0 = {
  tiny: 0.875,
...
}, s0 = S.images.types, X5 = Object.entries(S).reduce(
  (t, [l, e]) => ({
    ...t,
...
async function q5(t, l) {
  const e = S[l].types, a = S[l].prefix;
  return Array.from(t).filter(Boolean).filter((o) => {
    if (!o || !(o instanceof File))
      return console.warn("Invalid file object:", o), !1;
    const v = o.type.startsWith(`${a}/`), s = e.some(
      (m) => o.type.includes(m) || o.name.toLowerCase().endsWith(`.${m}`)
    );
    return v || s;
  });
}
...
function e2(t, l) {
  ...
  }) : Promise.resolve(J5(t));
}
function j(t) {
  const l = globalThis.URL;
  t.forEach(l.revokeObjectURL);
}
const a2 = /^[A-Za-z0-9+/=]+$/, i0 = "data:image/", d0 = /^data:image\/([a-z]+);base64,(.+)$/i, t2 = async (t) => {
  if (!t)
    return !1;
  try {
    if (t.startsWith(i0)) {
      ...
      if (!a)
        return !1;
      const n = a[1].toLowerCase(), c = a[2];
      if (!s0.includes(n) || !c || c.length === 0 || !/^[A-Za-z0-9+/]+={0,2}$/.test(c) || c.length % 4 === 1)
        return !1;
      try {
        return window.atob(c), !0;
      } catch {
        return !1;
      }
    }
  ...
  if (t.startsWith(i0)) {
    ...
    if (!l)
      return !1;
    const e = l[1];
    return s0.includes(e.toLowerCase());
  }
  return !!(t.length % 4 === 0 && a2.test(t));
};
function l2(t) {
  return C0() ? (N0(t), !0) : !1;
}
...
function n2(t, l) {
  if (t.length === 0 && l.length === 0)
    return "";
  const e = t.map((c) => `'${c}'`).toString(), a = l.filter((c) => typeof c == "function").map((c) => {
    const o = c.toString();
    return o.trim().startsWith("function") ? o : `const ${c.name} = ${o}`;
  }).join(";"), n = `importScripts(${e});`;
  return `${e.trim() === "" ? "" : n} ${a}`;
}
function s2(t) {
  return (l) => {
...
function i2(t, l, e) {
  const a = `${n2(l, e)}; onmessage=(${s2})(${t})`, n = new Blob([a], { type: "text/javascript" });
...
function d2(t, l = {}) {
  const {
    ...
    timeout: n,
    window: c = o2
  } = l, o = M(), v = X("PENDING"), s = M({}), i = X(), m = (C = "PENDING") => {
    o.value && o.value._url && c && (o.value.terminate(), URL.revokeObjectURL(o.value._url), s.value = {}, o.value = void 0, c.clearTimeout(i.value), v.value = C);
  };
  m(), l2(m);
  const L = () => {
    const C = i2(t, e, a), f = new Worker(C);
    return f._url = C, f.onmessage = (N) => {
      const { resolve: E = () => {
      }, reject: u = () => {
      } } = s.value, [p, w] = N.data;
      switch (p) {
      ...
      N.preventDefault(), E(N), m("ERROR");
    }, n && (i.value = setTimeout(
      () => m("TIMEOUT_EXPIRED"),
      n
    )), f;
  }, T = (...C) => new Promise((f, N) => {
    ...
    s.value = {
      resolve: f,
      reject: N
    }, (E = o.value) == null || E.postMessage([[...C]]), v.value = "RUNNING";
  });
  return {
    workerFn: (...C) => v.value === "RUNNING" ? (console.error(
      "[useWebWorkerFn] You can only run one instance of the worker at a time."
    ), Promise.reject()) : (o.value = L(), T(...C)),
    workerStatus: v,
    workerTerminate: m
  };
}
function h0() {
  const { workerFn: t, workerStatus: l } = d2(
    (e) => {
      const a = "data:image/", n = /^data:image\/([a-zA-Z0-9]+)(?:;[^;]+)*;base64,/i, c = /^[A-Za-z0-9+/=]+$/;
      if (e)
        try {
          if (e.startsWith(a)) {
            const o = e.match(n);
            if (!o)
              return;
            const v = e.split(",")[1];
            return !v || !c.test(v) ? void 0 : { type: "base64", mime: o[1].toLowerCase() };
          }
...
const t0 = "data:image/", Q = (t, l) => {
  if (!(!t || !l || l.type === void 0))
    return l.type === "base64" ? t.startsWith(t0) ? t : `${t0}${l.mime};base64,${t}` : t;
}, r2 = (t, l, e) => {
  t.value = null, l.value = !1, e.value = void 0;
}, h2 = async (t, l, e) => {
  const { getImageStringType: a } = h0();
  if (!await t2(t)) {
  ...
  l.value = c, e.value = Q(t, l.value);
}, v2 = async (t, l, e) => {
  const { getImageStringType: a } = h0(), n = await a(t);
  l.value = n ?? null, e.value = Q(t, l.value);
}, u2 = async (t, l, e, a, n, c) => {
  if (!t) {
    r2(l, e, c);
    return;
  }
  try {
    if (e.value = !0, a.value = !1, n.value = r0(t), n.value) {
      try {
        await h2(t, l, c);
      } catch (o) {
...
}), v0 = /* @__PURE__ */ R(p2, [["__scopeId", "data-v-9bda909b"]]), _2 = ["test-id"], m2 = ["src", "alt", "width", "height"], f2 = ["src", "alt", "width", "height"], Z2 = /* @__PURE__ */ b({
  __name: "ImagePreview",
  props: {
    width: { default: 40 },
    height: { default: 40 },
  ...
  setup(t) {
    const l = t, { URL: e } = globalThis, a = M(!0), n = M(!1), c = M(!1), o = X(null), v = M(void 0);
    return F(
      () => l.imageSrc,
      async (s) => {
        if (!s) {
      ...
      "test-id": `tds-image-preview-${n.value ? "error" : a.value ? "loading" : "loaded"}`
    }, [
      v.value && !n.value && c.value ? (h(), _("img", {
        key: 0,
        src: v.value,
        alt: l.alt,
        width: s.width,
        height: s.height,
        decoding: "async"
      }, null, 8, m2)) : v.value && !n.value ? (h(), _("img", {
        key: 1,
        src: v.value,
        alt: l.alt,
        width: s.width,
        ...
        decoding: "async",
        loading: "lazy",
        class: B({ "visually-hidden": a.value }),
        onError: i[0] || (i[0] = (m) => n.value = !0),
        onLoad: i[1] || (i[1] = (m) => a.value = !1)
      }, null, 42, f2)) : O("", !0),
      a.value && !c.value && !n.value ? (h(), H(v0, {
        key: 2,
        width: s.width,
        height: s.height
...
}), u0 = /* @__PURE__ */ R(Z2, [["__scopeId", "data-v-8a5e33c8"]]), M2 = {
  key: 1,
...
}, I2 = ["onClick"], O2 = ["aria-label"], C2 = ["multiple", "accept"], N2 = { class: "drop-zone__label" }, E2 = { class: "drop-zone__description" }, g2 = {
  key: 0,
  ...
  setup(t, { expose: l, emit: e }) {
    const a = t, n = e, c = M(!1), o = M(null), v = M(!1), s = M([]);
    l0(() => {
      (!a.instanceName || a.instanceName.trim() === "") && console.error("Missing or empty DropZone instanceName prop"), a.modelValue && (s.value = a.modelValue);
    }), F(
      () => a.modelValue,
      (u) => {
        s.value = u || [];
    ...
    const i = I(() => (a.displayFileList || !a.displayPreview && !a.displayFileList) && s.value.length > 0), m = I(() => ({
      mime: Q5(a.allowedFileTypes),
    ...
    async function L(u) {
      if (!v.value)
        try {
          v.value = !0;
          const p = await q5(u, a.allowedFileTypes);
          if (p.length > 0) {
            const w = a.allowedFileTypes === "images", A = await Promise.all(
              p.map(async (D) => ({
                file: D,
                name: D.name,
                preview: await e2(D, w)
              }))
            );
            s.value = a.multiple ? [...s.value, ...A] : A, n(`${a.instanceName}-drop`, u);
          } else
            n(
          ...
          n(
            `${a.instanceName}-drop-error`,
            p instanceof Error ? p.message : "An unknown error occurred"
          );
        } finally {
          v.value = !1;
        }
    ...
    function T(u) {
      u.preventDefault(), c.value = !0;
    }
    function P(u) {
      u.preventDefault(), c.value = !1;
    }
    async function C(u) {
      u.preventDefault(), c.value = !1;
      const p = u.dataTransfer?.files;
      p && p.length > 0 && await L(p);
    }
    function f() {
      o.value?.click();
    }
    async function N(u) {
      const { files: p } = u.target;
      p && p.length > 0 && (await L(p), u.target.value = "");
    }
    function E(u) {
      const p = s.value[u];
      p?.preview && j([p.preview]), s.value.splice(u, 1), p && n(`${a.instanceName}-remove`, p);
    }
    return l({
      /**
      ...
      const u = s.value.map((p) => p.preview);
      j(u), s.value = [];
    }), (u, p) => u.instanceName ? (h(), _("div", M2, [
      u.displayPreview && s.value.length > 0 ? (h(), _("div", L2, [
        (h(!0), _(W, null, G(s.value, (w, A) => (h(), _("button", {
          key: A,
          onClick: Y((D) => E(A), ["stop"])
        }, [
          (h(), H(u0, {
            key: A,
            "image-src": w.preview,
      ...
      g("div", {
        class: B(["drop-zone", {
          "drop-zone--dragging": c.value,
          "drop-zone--processing": v.value
        }]),
        onDragover: T,
        onDragleave: P,
        onDrop: C,
        ...
        g("strong", N2, U(a.label), 1),
        g("p", E2, [
          m.value ? (h(), _("span", g2, " (" + U(m.value.extensions.join(", ")) + ") ", 1)) : O("", !0)
        ])
      ], 42, O2),
      i.value ? (h(), _("div", H2, [
        (h(!0), _(W, null, G(s.value, (w, A) => (h(), H(z, {
          key: A,
...
}), V2 = /* @__PURE__ */ R(A2, [["__scopeId", "data-v-67caf3da"]]), T2 = ["data-checkbox-position", "data-full-width", "data-size", "test-id"], w2 = ["checked", "disabled", "aria-checked", "aria-disabled"], y2 = { class: "checkbox__visual" }, b2 = {
  key: 0,
  ...
  setup(t, { emit: l }) {
    const e = t, a = l, c = `checkbox-${E0()?.uid ?? Math.random().toString(36).substring(2, 11)}`, o = I(() => a0[e.size] || a0.medium), v = I(() => e.disabled ? "neutral-300" : e.checked ? e.color : "neutral-400"), s = () => {
      if (e.disabled) return;
      const i = !e.checked;
      a("update:checked", i), a("change", i);
    };
    return (i, m) => (h(), _("label", {
      for: c,
      class: B(["tot-ds-root checkbox", {
        "checkbox-checked": i.checked,
        "checkbox-disabled": i.disabled
      }]),
      "data-checkbox-position": i.checkboxPosition,
      "data-full-width": i.fullWidth,
      "data-size": i.size,
      "test-id": `tds-checkbox-${i.checked ? "checked" : "unchecked"}`
    }, [
      g("input", {
        id: c,
        type: "checkbox",
      ...
      i.$slots.default ? (h(), _("span", b2, [
        o0(i.$slots, "default", {}, void 0, !0)
      ])) : O("", !0)
    ], 10, T2));
  }
}), p0 = /* @__PURE__ */ R(R2, [["__scopeId", "data-v-6fb9b7ec"]]), k2 = { class: "tooltip-trigger" }, U2 = ["data-position", "aria-hidden", "test-id"], P2 = { class: "tooltip-box" }, D2 = { class: "tooltip-text" }, B2 = /* @__PURE__ */ b({
  __name: "Tooltip",
  props: {
    content: {},
  ...
  emits: ["show", "hide"],
  setup(t, { emit: l }) {
    const e = t, a = l, n = M(!1), c = M("top"), o = M(null);
    let v = null, s = null;
    F(
      () => e.position,
      (f) => {
    ...
    const i = () => {
      if (!o.value) return;
      const f = o.value.getBoundingClientRect(), N = window.innerWidth, E = window.innerHeight;
      let u = e.position;
      switch (e.position) {
        case "top":
          f.top < 0 && (u = "bottom");
      ...
      e.disabled || (s && (clearTimeout(s), s = null), v = setTimeout(() => {
        n.value = !0;
      }, e.delay));
    }, L = () => {
      v && (clearTimeout(v), v = null), s = setTimeout(() => {
        n.value = !1, c.value = e.position;
      }, 100);
    }, T = () => {
      m(), a("show");
    }, P = () => {
    ...
    return F(n, async (f) => {
      ...
      g("div", k2, [
        o0(f.$slots, "default", {}, void 0, !0)
      ]),
      n.value && !f.disabled ? (h(), _("div", {
        key: 0,
        ref_key: "tooltipRef",
        ref: o,
        ...
        role: "tooltip",
        "aria-hidden": !n.value,
        "test-id": `tds-tooltip-content-${c.value}`
      }, [
        g("div", P2, [
          g("span", D2, U(f.content), 1)
        ])
      ], 8, U2)) : O("", !0)
    ], 32));
  }
}), _0 = /* @__PURE__ */ R(B2, [["__scopeId", "data-v-eb81e19d"]]), F2 = ["test-id"], z2 = {
  key: 0,
  class: "multiselect__input-wrapper"
}, S2 = ["id", "name", "placeholder", "disabled"], $2 = ["tabindex", "onKeydown"], x2 = { class: "multiselect__trigger-text" }, W2 = { class: "multiselect__actions" }, G2 = {
  key: 0,
  class: "multiselect__dropdown"
}, Y2 = { class: "multiselect__options" }, K2 = {
  key: 0,
  class: "multiselect__no-options"
}, j2 = {
  key: 0,
  class: "multiselect__selected-wrapper"
}, X2 = { class: "multiselect__selected-tags" }, Q2 = /* @__PURE__ */ b({
  __name: "Multiselect",
  props: {
    options: {},
    modelValue: { default: () => [] },
  ...
  setup(t, { emit: l }) {
    const e = t, a = l, n = I(
    ...
    ), c = I(() => e.searchable ? e.searchPlaceholder || "Search..." : e.selectPlaceholder || "Select options..."), o = M(!1), v = M(!1), s = M(""), i = M(null), m = M(null), L = I(() => e.modelValue || []), T = I(() => {
      if (!e.searchable || !s.value)
        return e.options;
      const r = s.value.toLowerCase();
      return e.options.filter(
        (Z) => Z.label.toLowerCase().includes(r)
      );
    }), P = I(() => L.value.map((r) => e.options.find((Z) => Z.value === r)).filter((r) => r !== void 0)), C = I(() => P.value.map((r) => r.label)), f = (r) => L.value.includes(r.value), N = I(() => e.maxSelections !== void 0 && L.value.length >= e.maxSelections), E = (r) => r.disabled || N.value && !f(r), u = () => {
      e.disabled || (o.value ? p() : (o.value = !0, a("open")));
    }, p = () => {
      o.value && (o.value = !1, s.value = "", m.value && m.value.blur(), a("close"));
    }, w = (r) => {
      if (E(r))
        return;
      const Z = [...L.value], d = Z.indexOf(r.value);
      d > -1 ? (Z.splice(d, 1), a("option-deselect", r)) : N.value || (Z.push(r.value), a("option-select", r)), a("update:modelValue", Z), a("change", Z), e.closeOnSelect && p();
    }, A = (r, Z) => {
      Z.stopPropagation();
      const d = L.value.filter((V) => V !== r);
      a("remove-tag", r), a("update:modelValue", d), a("change", d);
    }, D = (r) => {
      r.stopPropagation(), a("clear"), a("update:modelValue", []), a("change", []);
    }, q = (r) => {
      i.value && !i.value.contains(r.target) && p();
    }, f0 = () => {
      v.value = !1;
    }, Z0 = () => {
      v.value = !0;
      ...
      const d = r;
      d.style.height = "0", d.style.opacity = "0", d.style.marginTop = "0", d.style.overflow = "hidden", d.offsetHeight, d.style.transition = "all 0.4s cubic-bezier(0.4, 0.0, 0.2, 1)", d.style.height = `${d.scrollHeight}px`, d.style.opacity = "1", d.style.marginTop = "0.5rem";
      const V = () => {
        d.style.height = "auto", d.style.overflow = "visible", d.removeEventListener("transitionend", V), Z();
      };
      d.addEventListener("transitionend", V);
    }, I0 = (r, Z) => {
      const d = r;
      d.style.height = `${d.scrollHeight}px`, d.style.overflow = "hidden", d.offsetHeight, d.style.transition = "all 0.4s cubic-bezier(0.4, 0.0, 0.2, 1)", d.style.height = "0", d.style.opacity = "0", d.style.marginTop = "0";
      const V = () => {
        d.removeEventListener("transitionend", V), Z();
      };
      d.addEventListener("transitionend", V);
    };
    return l0(() => {
      ...
      ref_key: "dropdownRef",
      ref: i,
      class: B(["tot-ds-root multiselect", [
        `multiselect-size-${r.size}`,
        {
          "multiselect-disabled": r.disabled,
          "multiselect-open": o.value,
          "multiselect-dropdown-animating": v.value
        }
      ]]),
      "test-id": `tds-multiselect-${o.value ? "open" : "closed"}`
    }, [
      r.searchable ? (h(), _("div", z2, [
        A0(g("input", {
          ref_key: "inputRef",
          ref: m,
      ...
      k(J, {
        ...
        default: x(() => [
          o.value ? (h(), _("div", G2, [
            r.maxSelections !== void 0 ? (h(), _("div", {
              key: 0,
              class: B(["multiselect__limit-info", { "multiselect__limit-info--max": N.value }])
            }, U(L.value.length) + " / " + U(r.maxSelections) + " selected ", 3)) : O("", !0),
            g("ul", Y2, [
              (h(!0), _(W, null, G(T.value, (d) => (h(), _("li", {
                key: d.value,
                class: B(["multiselect__option", {
                  "multiselect__option-selected": f(d),
                  "multiselect__option-disabled": E(d)
                }])
              }, [
                k(p0, {
                  checked: f(d),
                  ...
                  size: "small",
                  "full-width": "",
                  "checkbox-position": r.checkboxPosition,
                  color: "black",
              ...
              T.value.length === 0 ? (h(), _("li", K2, " No options found ")) : O("", !0)
            ])
          ])) : O("", !0)
        ]),
        _: 1
      ...
      k(J, {
        ...
        default: x(() => [
          C.value.length > 0 ? (h(), _("div", j2, [
            g("div", X2, [
              (h(!0), _(W, null, G(C.value, (d, V) => (h(), H(z, {
                key: V,
...
`, o4 = ["data-mode", "data-variant", "innerHTML"], n4 = /* @__PURE__ */ b({
  __name: "LogoToteat",
  props: {
  ...
  setup(t) {
    const l = t, e = I(() => l.mode === "icon" ? {
      ...
      "cream-orange": e4,
      "black-cream": a4
    }[l.variant]), a = I(() => l.width && l.height ? { width: l.width, height: l.height } : l.mode === "icon" ? {
      width: l.width ?? 44,
      height: l.height ?? 44
    } : l.width ? {
      width: l.width,
      ...
      width: 160,
      height: 40
    }), n = I(() => e.value.replace(/width="\d+"/, `width="${a.value.width}"`).replace(/height="\d+"/, `height="${a.value.height}"`).replace(/<svg/, `<svg role="img" aria-label="${l.alt}"`));
    return (c, o) => (h(), _("picture", {
...
}), s4 = /* @__PURE__ */ R(n4, [["__scopeId", "data-v-2456a115"]]), m0 = (t) => {
  t.component("Button", z), t.component("Checkbox", p0), t.component("DropZone", V2), t.component("Icon", y), t.component("ImagePreview", u0), t.component("LogoToteat", s4), t.component("Multiselect", q2), t.component("SkeletonPreload", v0), t.component("Spinner", n0), t.component("Tooltip", _0);
}, d4 = {
  install: m0
}, r4 = {
  install: m0
